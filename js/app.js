(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".main-block__slider-arrows .slider-arrow__prev",
                nextEl: ".main-block__slider-arrows .slider-arrow__next"
            },
            on: {}
        });
    }
    ...
    document.addEventListener("DOMContentLoaded", (function(e) {
        document.addEventListener("click", (function(e) {
            ...
            if (targetElement.classList.contains("actions-header__item_search")) {
                ...
                document.querySelector(".header__search.search-form").classList.toggle("open");
            } else if (!targetElement.closest(".header__search.search-form") && document.querySelector(".header__search.search-form.open")) {
                document.querySelector(".actions-header__item_search").classList.remove("open");
                document.querySelector(".header__search.search-form").classList.remove("open");
            }
        }));
    }));
    window["FLS"] = true;
